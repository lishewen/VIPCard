...
Public Class AdminIdentity
    ...
    Private adminValue As Salesman
    ...
    Private Function IsValidCard(cardno As String) As Boolean
        adminValue = db.Salesmen.Where(Function(a) a.卡号 = cardno).FirstOrDefault
        Return adminValue IsNot Nothing
    End Function

    Private Function IsValidPass(username As String, password As String) As Boolean
        password = Utils.MD5(password)
        adminValue = db.Salesmen.Where(Function(a) a.姓名 = username AndAlso a.密码 = password).FirstOrDefault
        Return adminValue IsNot Nothing
    End Function
    ...
    Public ReadOnly Property Admin As Salesman
        Get
            Return adminValue
        End Get
    End Property
