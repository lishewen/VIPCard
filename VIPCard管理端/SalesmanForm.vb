...
Public Class SalesmanForm
    ...
    Private Sub SalesmanForm_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        If MsgBox("是否保存已做的修改！", MsgBoxStyle.YesNo, Me.Text) = MsgBoxResult.Yes Then
            db.SaveChanges()
        End If
    End Sub

    Private Sub SalesmanForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        BindingSource.DataSource = db.Salesmen
    End Sub
